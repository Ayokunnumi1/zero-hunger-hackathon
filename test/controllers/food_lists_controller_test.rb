...
class FoodListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create food_list" do
    assert_difference("FoodList.count") do
      post food_lists_url, params: { food_list: { collected_from: @food_list.collected_from, donar_name: @food_list.donar_name, donate_date: @food_list.donate_date, food_amount: @food_list.food_amount, food_name: @food_list.food_name } }
    end
  ...
  test "should update food_list" do
    patch food_list_url(@food_list), params: { food_list: { collected_from: @food_list.collected_from, donar_name: @food_list.donar_name, donate_date: @food_list.donate_date, food_amount: @food_list.food_amount, food_name: @food_list.food_name } }
